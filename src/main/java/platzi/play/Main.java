...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        plataforma.getContenidoPromocionable().forEach(promocionable -> System.out.println(promocionable.promocionar())); //Llamado por método de referencia a la interfaz
