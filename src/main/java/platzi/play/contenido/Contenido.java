...
public class Contenido {
    ...
    //Constructor
    public Contenido(String titulo, int duracion, Genero genero, Idioma idioma) {
        this.titulo = titulo;
    ...
    public Contenido(String titulo, int duracion, Genero genero, double calificacion, Idioma idioma) {
